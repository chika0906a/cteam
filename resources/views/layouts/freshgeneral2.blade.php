...
<meta charset="utf-8">
    ...
    <title>{{ config('app.name', 'Fresh') }}</title>
   ...
   .content1 {font-size:12pt; color:#ffffff;margin:0px -40 40px 0px; line-height:0; text-align: center ;}
   
   .content2 {font-size:20pt; color:#ffffff;margin:-250px 0 0px 0px; line-height:0; text-align: center ;}

   .content3 {font-size:12pt; color:#ffffff;margin:50px 0 40px 0px; line-height:0; text-align: center ;}

   .content4 {font-size:12pt; color:#ffffff;margin:30px 0 0px 0px; line-height:0; text-align: center ;}
