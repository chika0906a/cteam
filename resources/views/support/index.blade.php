...
@section('content')
    <form action="/support2/find" method="post">
    @csrf
   ...
   @foreach ($items as $item)
       <tr>
           ...
           <td><a href="/support2/show?support_num={{$item->support_num}}">詳細</a></td>
           <td><a href="/support2/del?support_num={{$item->support_num}}">削除</a></td>
       </tr>
   @endforeach
   </table>
