...
ECHO '<FONT COLOR="white"> お知らせフォーム送信確認画面 </FONT>';
?>
...
@endsection
@section('content3')
<p>上記の内容でよろしければ「送信」ボタンを押してください。</P>
   <form action="info" method="post">
   <button type="submit" style="width:75px; height:30px"; value="send">送信<button type="submit" style="width:75px; height:30px"; value="send">戻る<br><br>
   <?PHP
