...
@section('content')
    <form action="fresh/management/companysupport/find" method="post">
    @csrf
   ...
   @foreach ($items as $item)
       <tr>
           ...
           <td><a href="fresh/management/companysupport/show?support_num={{$item->support_num}}">詳細</a></td>
           <td><a href="fresh/management/companysupport/del?support_num={{$item->support_num}}">削除</a></td>
       </tr>
   @endforeach
   </table>
